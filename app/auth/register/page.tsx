...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Akun berhasil dibuat! Cek email untuk verifikasi sebelum login.')
      setLoading(false)
    } catch (err: any) {
  ...
  return (
    <div className="register-wrapper">
      ...
      <div className="card register-card p-4 p-md-5">
        <div className="text-center mb-4">
          ...
          <p className="text-muted small">
            Sudah punya akun?{' '}
            <Link href="/auth/login" className="link-primary">Masuk di sini</Link>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {success ? 'Balik ke Login' : loading ? 'Mendaftar...' : 'Daftar Sekarang'}
          </button>
        </form>
      ...
      <style jsx>{`
        ...
        .bear-canvas { width: 100%; height: 100%; }
        .register-card {
          max-width: 460px;
          width: 100%;
          border-radius: 22px;
        ...
        .divider span { font-size: 12px; color: #999; }
        .divider hr { flex: 1; }
        .btn-google {
          border-radius: 12px;
