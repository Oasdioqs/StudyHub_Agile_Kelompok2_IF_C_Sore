...
function formatLoginError(e: unknown): string {
  if (e instanceof TypeError) {
    return 'Tidak terhubung ke server. Periksa internet lalu coba lagi.'
  }
      ...
      >
        ...
        >
          ...
          <View style={styles.hero}>
            <Text style={styles.title}>Masuk ke StudyHub</Text>
          </View>
          ...
          <View style={[styles.card, shadows.card]}>
            ...
            <Pressable style={styles.linkRow} onPress={() => router.push('/register')} disabled={loading}>
