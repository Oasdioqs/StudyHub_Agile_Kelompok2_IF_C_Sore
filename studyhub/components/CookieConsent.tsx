...
export function CookieConsent() {
  ...
  return (
    <>
      {isMobile ? (
        /* Mobile: full-width banner di atas bottom nav */
        <div
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            ...
            <p style={{ margin: 0, fontSize: 12.5, color: 'var(--sh-text)', fontWeight: 600, lineHeight: 1.5 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button
              ...
              style={{
                ...
                border: '1.5px solid var(--sh-border)', background: 'transparent',
                color: 'var(--sh-muted)', fontSize: 13, fontWeight: 600, cursor: 'pointer',
              }}
            >
              Tolak
            </button>
        ...
        /* Desktop: floating card di tengah bawah */
        <div
          className="animate-fade-up"
          style={{
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ margin: '4px 0 0', fontSize: 12.5, color: 'var(--sh-muted)', lineHeight: 1.6 }}>
                Untuk pengalaman terbaik dan analytics. Baca{' '}
                <Link href="/privacy" style={{ color: '#4f46e5', fontWeight: 600 }}>Privacy Policy</Link> kami.
              </p>
            </div>
          </div>
